<template>
  <div>
    ...
    <el-button type="text" class="add" @click="dialogVisible = true">+</el-button>
    ...
    <el-button type="text" class="add" @click="dialogVisibleTag = true">+ </el-button>
    ...
    <el-row>
      <el-button class="submit" @click="addArticle" type="success" round>发表文章</el-button>
    </el-row>
  </div>
</template>
